# Phase 6.5 タスク管理 — 事故報お任せグッジョくん演出
...
- [ ] `public/goodjob-kun.png` — 暫定で透明 PNG、または絵文字スタイルの仮素材（ユーザー対応）
...
- [ ] ヘッダー、ログイン画面、生成中ダイアログ、編集画面、確定画面でグッジョくんが見えること
- [ ] 文言が「グッジョくん」基調に統一されていること
- [ ] 画像素材が無い状態でも絵文字フォールバックで崩れないこと
